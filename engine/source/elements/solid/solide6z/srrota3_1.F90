...
! ======================================================================================================================
! \brief SRROTA3_1 Subroutine
! \details This subroutine performs coordinate transformations for solid elements.
!          It is called by various routines in the solid and thick shell elements modules.
!          - Input: Rotation matrices (R11, R12, ..., R33) and coordinates (X1, Y1, Z1, ..., X6, Y6, Z6)
!          - Output: Transformed coordinates
! ======================================================================================================================
      module srrota3_2_mod
            contains
            subroutine srrota3_2(r11, r12, r13, r21, r22, r23, r31, r32, r33, &
                               x1, x2, x3, x4, x5, x6, &
                               y1, y2, y3, y4, y5, y6, &
...
! Perform coordinate transformations for each element
      ...
      return
        end subroutine srrota3_2
      end module srrota3_2_mod